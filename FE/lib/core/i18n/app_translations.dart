...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'vi_VN': {
      ...
      'sidebar.brandSubtitle': 'HỆ THỐNG QUẢN LÝ VỤ VIỆC',
      'sidebar.cases': 'Danh sách vụ việc',
      'sidebar.createCase': 'Thêm vụ việc',
      'sidebar.stations': 'Quản lý đồn biên phòng',
      'sidebar.userManagement': 'Quản lý người dùng',
      'sidebar.banners': 'Quản lý banner',
      'sidebar.legalDocs': 'Văn bản quy phạm',

      // Dashboard titles/breadcrumbs
      'nav.breadcrumb.cases': 'Trang chủ  /  Quản lý vụ việc',
      'nav.title.cases': 'Danh sách vụ việc',
      ...
      'nav.breadcrumb.legalDocs': 'Hệ thống  /  Văn bản quy phạm',
      'nav.title.legalDocs': 'Quản lý văn bản pháp luật',

      // Cases
      'cases.headerDesc':
          'Theo dõi, cập nhật và quản lý hồ sơ các vụ việc trên địa bàn tỉnh Lai Châu.',
      'cases.addNew': 'Thêm vụ việc mới',
      ...
      'cases.table.title': 'TÊN VỤ VIỆC / NỘI DUNG',
      ...
      'admins.validation.usernamePassword':
    ...
    'en_US': {
      ...
      'sidebar.legalDocs': 'Legal Documents',
      ...
      'nav.breadcrumb.legalDocs': 'System  /  Legal Documents',
      'nav.title.legalDocs': 'Legal Documents',

      // Cases
      'cases.headerDesc':
          'Track, update and manage cases in Lai Chau province.',
