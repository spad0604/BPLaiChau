              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'Lưu ý: API sẽ trả 403 nếu không phải Super Admin.',
                    ...
                    if (embedded && nav != null) ...[
                      ...
                      TextButton(
                        ...
                        child: const Text('Quay về danh sách vụ việc'),
                      ),
                    ],
                  ],
                ),
