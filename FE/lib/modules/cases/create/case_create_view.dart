                      ...
                      children: [
                        ...
                        Obx(() {
                          ...
                          final items = <AppDropdownItem<String>>[
                            const AppDropdownItem(value: '', label: 'Chọn đồn biên phòng (không bắt buộc)'),
                            ...list.map((s) => AppDropdownItem(value: s.stationId, label: s.name)),
                          ];
                    ...
                    child: Column(
                      children: [
                        ...
                        AppTextField(
                          ...
                          hint: 'Mô tả chi tiết diễn biến vụ việc...',
                            ...
                            return Column(
                              children: [
                                  ...
                                  children: [
                                    Expanded(
                                      child: AppTextField(
                                        ...
                                        hint: 'Ví dụ: Bàn giao CSĐT Công an...',
                                        controller:
                                            controller.handlingMeasureCtrl,
                                        maxLines: 2,
                                      ),
                                    ),
                                    const SizedBox(width: 16),
                                    Expanded(
                                      child: AppTextField(
                                        ...
                                        hint:
                                            'Ví dụ: Tàng trữ trái phép chất ma túy...',
                                        controller:
                                            controller.prosecutedBehaviorCtrl,
                                        maxLines: 2,
                                      ),
                                    ),
                                  ],
                                ...
                                Row(
                                  children: [
                                    const Expanded(
                                      child: Text('Tang chứng / vật chứng', style: TextStyle(fontWeight: FontWeight.w600)),
                                    ),
                                    TextButton.icon(
                                          ...
                                          children: [
                                            Expanded(
                                              ...
                                              child: AppTextField(
                                                ...
                                                hint: 'Ví dụ: Heroin, xe máy, điện thoại...',
                                            ...
                                            IconButton(
                                              tooltip: 'Xóa',
                                              onPressed: () => controller.removeSeizedItem(i),
                                  ...
                                  children: [
                                    Expanded(
                                      child: Container(
                                        ...
                                        child: Row(
                                          children: [
                                            const Icon(Icons.insert_drive_file_outlined, size: 18, color: Colors.black54),
                                            const SizedBox(width: 8),
                                            Expanded(
                                              child: Text(
                                                f.name,
