...
class AppPages {
  static final pages = [
    ...
    GetPage(name: Routes.dashboard, page: () => const DashboardShell(), binding: DashboardBinding()),

    // Keep old paths for compatibility (they render the same dashboard shell)
    GetPage(name: Routes.caseList, page: () => const DashboardShell(), binding: DashboardBinding()),
